        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline" ref="formInline">
          <div>
            ...
            <el-form-item>
              ...
              <el-button type="success" icon="el-icon-bottom" @click="exportList">Export</el-button>
    ...
    <el-dialog
      ...
      <div v-else>
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="Main Information" name="1">
            <el-form :inline="true" :model="formInline3" class="demo-form-inline" label-width="120px">
              <el-form-item label="Partid">
                <el-select v-model="formInline3.Partid">
                </el-select>
              </el-form-item>
              <el-form-item label="POQty">
                <el-input v-model="formInline3.POQty"></el-input>
              </el-form-item>
              <el-form-item label="DueDate">
                <el-input v-model="formInline3.DueDate"></el-input>
              </el-form-item>
              <el-form-item label="Comments">
                <el-input v-model="formInline3.Comments"></el-input>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label="Price Relate" name="2">
            <el-form :inline="true" :model="formInline4" class="demo-form-inline" label-width="120px">
              <el-form-item label="LT">
                <el-input v-model="formInline4.LT"></el-input>
              </el-form-item>
              <el-form-item label="MOQ">
                <el-input v-model="formInline4.MOQ"></el-input>
              </el-form-item>
              <el-form-item label="UnitPrice">
                <el-input v-model="formInline4.UnitPrice"></el-input>
              </el-form-item>
            </el-form>
          </el-tab-pane>
        </el-tabs>
